<header>
	...
	<div class="nav-wrapper">
		<nav>
			<ul>
				<li><a href="#/">{ firstName($currentUser.name)}'s Home</a></li>
				<li><a href="#/place">{ firstName($currentUser.name)}'s Places</a></li>
				<li><a href="#/group">{firstName($currentUser.name)}'s Group Trips</a></li>
			</ul>
...
<script>
  ...
  import { users, currentUser } from "src/stores/index.js";
...
<style lang="scss">
  ...
  .header-img1 {
    @include header("/assets/images/header1.jpg");
  }

  .header-img2 {
    @include header("/assets/images/header2.jpg");
  }

  .header-img3 {
    @include header("/assets/images/header3.jpg");
  }
